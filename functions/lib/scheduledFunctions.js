...
exports.autoMarkUncollected = exports.dailyStockReset = void 0;
 ...
 */
exports.dailyStockReset = (0, scheduler_1.onSchedule)({ schedule: '0 5 * * *', timeZone: 'Africa/Johannesburg' }, async () => {
    try {
        // Get all menuItems
 ...
 */
exports.autoMarkUncollected = (0, scheduler_1.onSchedule)('every 5 minutes', async () => {
    try {
        ...
        for (const [userId, increment] of Object.entries(userUpdates)) {
            ...
            const updateData = { noShowCount: newNoShowCount };
            if (newNoShowCount >= 3) {
